...
def main():
    ...
    # Load datasets
    print("\nLoading datasets...")
    train_dataset = WordSplitDataset('train_mixed.csv', tokenizer, config.max_length)
    val_dataset = WordSplitDataset('val_mixed.csv', tokenizer, config.max_length)
    test_dataset = WordSplitDataset('test_mixed.csv', tokenizer, config.max_length)
