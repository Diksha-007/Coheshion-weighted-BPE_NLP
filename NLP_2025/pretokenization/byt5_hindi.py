...
class WordSplitDataset(Dataset):
    def __init__(self, csv_path, tokenizer, max_length):
        ...
        self.data = self.data.dropna(subset=['Sandhi', 'Split'])
        # Convert to string to handle any non-string values
        self.data['Sandhi'] = self.data['Sandhi'].astype(str)
    ...
    def __getitem__(self, idx):
        ...
        input_text = str(row['Sandhi']).strip()
...
def main():
    ...
    # Load datasets
    print("\nLoading datasets...")
    train_dataset = WordSplitDataset('hindi_train.csv', tokenizer, config.max_length)
    val_dataset = WordSplitDataset('hindi_val.csv', tokenizer, config.max_length)
    test_dataset = WordSplitDataset('hindi_test.csv', tokenizer, config.max_length)
