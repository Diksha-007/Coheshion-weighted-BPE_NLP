...
train_df = pd.read_csv("train_mixed.csv")
val_df   = pd.read_csv("val_mixed.csv")
test_df  = pd.read_csv("test_mixed.csv")
...
for epoch in range(30):   # You can keep a high max epoch
    ...
    if avg_val_loss < best_val_loss:
        ...
        counter = 0
        torch.save(model.state_dict(), "best_sandhi_model_mixed.pt")
...
plt.legend()
plt.show()
plt.savefig("train_val_loss_mixed.png")
...
model.load_state_dict(torch.load("best_sandhi_model_mixed.pt"))
model.eval()
