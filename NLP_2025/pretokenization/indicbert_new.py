...
patience = 2       # Stop if no improvement for these many epochs
...
for epoch in range(30):   # You can keep a high max epoch
    ...
    if avg_val_loss < best_val_loss:
        ...
        counter = 0
        torch.save(model.state_dict(), "best_sandhi_model.pt")
...
plt.legend()
plt.show()
plt.savefig("train_val_loss_sanskrit.png")
...
model.load_state_dict(torch.load("best_sandhi_model.pt"))
model.eval()
